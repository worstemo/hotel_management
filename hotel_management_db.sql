...
(3, '王阿姨', '保洁', '13833334444', 'wangayi@hotel.com', '宁夏银川市西夏区', 3500.00, '2025-11-01', 'Active');      -- 清洁，负责客房卫生
...
-- 【后台管理】settings.py中SIMPLEUI_CONFIG配置为"酒店管理-预定管理"菜单
-- ====================================================================================
...
-- 
-- 【下一步操作】
-- 1. 运行 python manage.py migrate 确保迁移记录与数据库同步
-- 2. 运行 python manage.py runserver 启动开发服务器
-- 3. 访问 http://127.0.0.1:8000/admin/ 登录管理后台
-- 4. 使用账户 admin/admin 登录
-- 
-- 【数据说明】
-- - 客户：3个示例客户（张亦涵、余瑞、李明）
-- - 员工：3个示例员工（江业平-前台、张博宸-经理、王阿姨-清洁）
